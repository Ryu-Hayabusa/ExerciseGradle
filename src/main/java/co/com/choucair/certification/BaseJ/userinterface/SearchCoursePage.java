package co.com.choucair.certification.BaseJ.userinterface;
...
public class SearchCoursePage extends PageObject {
    ...
    public static final Target NAME_COURSE = Target.the("Extrae el nombre del curso").located(By.xpath("//h4[contains(text(),'Recursos Automatización Bancolombia')]"));
}
